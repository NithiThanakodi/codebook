...
export const Checkout = ({ setCheckout }) => {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            clearCart();
            naviagte("/order-summary", { state: { status: true, data: data } })
        } catch (error) {
            toast.error(error.message, { closeButton: true, autoClose: 5000, position: "bottom-center" });
            naviagte("/order-summary", { state: { status: false, } })
        }
    }
                        ...
                        <div className="py-6 px-6 lg:px-8">
                            ...
                            <form className="space-y-6" onSubmit={handleSubmit} >
                                ...
                                <div>
                                    ...
                                    <input type="text" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:value-gray-400 dark:text-white" value={user.email || "backup@email.com"} disabled required="" />
                                </div>
                                <div>
