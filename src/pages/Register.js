...
export const Register = () => {
  ...
  async function handleRegister(e) {
    e.preventDefault();
    try {
      const authDetail = { name: e.target.name.value, email: e.target.email.value, password: e.target.password.value }
